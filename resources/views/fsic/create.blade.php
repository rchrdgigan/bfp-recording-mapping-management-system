<x-app-layout>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        @if (session('message'))
            <div class="mt-5 flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                        ...
                        <div class="post__content tab-content">
                            ...
                            <h1 class="text-lg font-semibold text-center">Information</h1>
                                ...
                                <div class="mt-4 intro-y">
                                    ...
                                    <x-jet-input id="estab" class="block mt-1 w-full text-xs" type="text" name="establishment" :value="old('establishment')" required autofocus />
                                </div>
                                <div class="mt-4 intro-y">
                                    <x-jet-label for="owner" value="{{ __('Name of Owner') }}" />
                                    <x-jet-input id="owner" class="block mt-1 w-full text-xs" type="text" name="owner" :value="old('owner')" required autofocus />
                                </div>
                                <div class="mt-4 intro-y">
                                    <x-jet-label for="business_types" value="{{ __('Business Types') }}" />
                                    <x-jet-input id="business_types" class="block mt-1 w-full text-xs" type="text" name="business_types" :value="old('business_types')" required autofocus />
                                </div>
                                <div class="mt-4 intro-y">
                                    <x-jet-label for="contact" value="{{ __('Contact Number') }}" />
                                    <x-jet-input id="contact" class="block mt-1 w-full text-xs" type="text" name="contact" :value="old('contact')" required autofocus />
                                </div>
                                <div class="mt-4 intro-y">
                                    <x-jet-label for="address" value="{{ __('Address') }}" />
                                    <x-jet-input id="address" class="block mt-1 w-full text-xs" type="text" name="address" :value="old('address')" required autofocus />
                                </div>
