                ...
                <div class="w-full">
                    <div class="intro-y box p-10">
                        ...
                        <div class="mt-4 intro-y">
                            ...
                            <x-jet-input id="fsic_no" class="block mt-1 w-full text-xs" type="text" name="fsic_no" :value="old('fsic_no')" required />
                        </div>
                        <div class="mt-4 intro-y">
                            <x-jet-label for="estab" value="{{ __('Name of Establishment') }}" />
                            <x-jet-input id="estab" class="block mt-1 w-full text-xs" type="text" name="establishment" :value="old('establishment')" required />
                        </div>
                        <div class="mt-4 intro-y">
                        ...
                        <div class="mt-4 intro-y">
                            ...
                            <x-jet-input id="business_types" class="block mt-1 w-full text-xs" type="text" name="business_types" :value="old('business_types')" required />
                        </div>
                        <div class="mt-4 intro-y">
